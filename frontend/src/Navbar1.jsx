        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px' }} navbarScroll>
            <Button style={{ "boxShadow": "0px 1px 5px 0px darkblue", "backgroundColor": "white", "color": "black", "margin": "7px" }}>
              <Link to='/$2a$12$GUbLTBEOUWUg4FSgaPJSousyzQZkyiRr2dmmVt4OwXmDUbCzh9v22' style={{ "textDecoration": "none", "color": "black" }}>Home</Link>
            </Button>
            <Button style={{ "boxShadow": "0px 1px 5px 0px darkblue", "backgroundColor": "white", "color": "black", "margin": "7px" }}>
              <Link to='/rooms' style={{ "textDecoration": "none", "color": "black" }}>Rooms</Link>
            </Button>
            <Button style={{ "boxShadow": "0px 1px 5px 0px darkblue", "backgroundColor": "white", "color": "black", "margin": "7px" }}>
              <Link to='/available' style={{ "textDecoration": "none", "color": "black" }}>Available</Link>
            </Button>
          </Nav>
